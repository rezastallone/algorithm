...
fun main() {
    ...
    //simulasi bahwa install tuh 30 hari yang lalu
...
//    waktuPertamaInstallDana.timeInMillis = waktuPertamaInstallDana.timeInMillis - ( 86400000L * 30 )
    ...
    //simulasi hari ini tuh 25 hari setelah pertama install, jadi 5 hari lagi harusnya skejulnya nyala
...
//    waktuSekarang.timeInMillis = waktuSekarang.timeInMillis - ( 86400000L * 10 )
    ...
    //kita kalkulasi dari selisih hari waktu sekarang dengan waktu pertama install
    ...
    //hasil perkalian itu akan ditambahkan dengan millis dari hari pertama install
